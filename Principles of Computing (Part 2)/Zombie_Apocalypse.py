...
class Zombie(poc_grid.Grid):
    ...
    def __init__(self, grid_height, grid_width, obstacle_list = None, 
        ...
        self._zombie_list = list(zombie_list) if zombie_list != None else []
        self._human_list  = list(human_list) if human_list != None else []
    ...
    def compute_distance_field(self, entity_type):
        ...
        visited.clear()
        distance_field = [[self.get_grid_height() * self.get_grid_width() for dummy_x in range(self.get_grid_width())] for dummy_y in range(self.get_grid_height())]
