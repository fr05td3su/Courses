...
x1 = solve(coldict2mat(button_vectors(9)), b1)

#residual
r1 = b1 - coldict2mat(button_vectors(9)) * x1
...
#Solution given by solver
x2 = solve(coldict2mat(button_vectors(9)), b2)  

#residual
r2 = b2 - coldict2mat(button_vectors(9)) * x2
