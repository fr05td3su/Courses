...
def orSearch(inverseIndex, query):
    ...
    """
    temp = set()
    #return {temp.update(inverseIndex[word]) for word in query}      
    for word in query:
        temp.update(inverseIndex.copy()[word])
    return temp
...
def andSearch(inverseIndex, query):
    ...
    return set.intersection(*[inverseIndex.copy()[word] for word in query])
